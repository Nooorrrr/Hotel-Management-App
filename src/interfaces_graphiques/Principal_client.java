...
public class Principal_client extends JFrame {
    ...
    public Principal_client() {
        ...
        person.setIcon(new ImageIcon("src/images/utilisateur-60.png"));
        ...
        addicon.setIcon(new ImageIcon("src/images/add-60.png"));
        addicon.setBounds(50, 320, 60, 50);
        panel.add(addicon);

        editicon.setIcon(new ImageIcon("src/images/edit-55.png"));
        editicon.setBounds(50, 420, 55, 55);
        panel.add(editicon);

        deleteicon.setIcon(new ImageIcon("src/images/delete-48.png"));
        ...
        deletebutton.setIcon(new ImageIcon("src/images/delete-32.png"));
        ...
        editbutton.setIcon(new ImageIcon("src/images/edit-40.png"));
        ...
        addbutton.setIcon(new ImageIcon("src/images/add-37.png"));
        ...
        jLabel15.setIcon(new ImageIcon("src/images/2.png"));
    ...
    private void addbuttonMousePressed(MouseEvent evt) {
        addbutton.setIcon(new ImageIcon("src/images/ajouter-37.png"));
    }

    private void editbuttonMousePressed(MouseEvent evt) {
        editbutton.setIcon(new ImageIcon("src/images/modify-40.png"));
    ...
    private void deletebuttonMousePressed(MouseEvent evt) {
        deletebutton.setIcon(new ImageIcon("src/images/supprimer-32.png"));
