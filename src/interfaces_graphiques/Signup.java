...
public class Signup extends JFrame {
    ...
    public Signup() {
        ...
        person.setIcon(new ImageIcon("src/images/personne-30.png"));
        ...
        right.setIcon(new ImageIcon("src/images/5.png"));
        right.setBounds(50, 0, 240, 550);
        panel.add(right);

        left.setIcon(new ImageIcon("src/images/6.png"));
